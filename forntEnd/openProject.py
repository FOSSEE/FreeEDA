#!/usr/bin/python
# openProject.py is a python script to open an existing project. It is developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  

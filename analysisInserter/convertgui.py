#!/usr/bin/python
# convertgui.py is a python script to create analysis option for ngspice. It is developed for FreeEDA software. It is written by Saket Choudhary (saketkc@gmail.com).  
...
class PageOne(wx.Panel):
  def __init__(self, parent):
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.start = wx.TextCtrl(self, -1, '', (150, 75), (60, -1))
    hbox.Add(self.start)
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.step = wx.TextCtrl(self, -1, '', (150, 75), (60, -1))
    hbox.Add(self.step)
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.stop = wx.TextCtrl(self, -1, '', (150, 75), (60, -1))
    hbox.Add(self.stop)
...
class PageTwo(wx.lib.scrolledpanel.ScrolledPanel):
  def __init__(self, parent):
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.start = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    hbox.Add(self.start)
    ...
    hbox.Add(self.startscale)
    self.start2 = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.step = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    hbox.Add(self.step)
    ...
    hbox.Add(self.stepscale)
    self.step2 = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    hbox.Add(self.step2)
    ...
    hbox = wx.BoxSizer(wx.HORIZONTAL)
    self.stop = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    hbox.Add(self.stop)
    ...
    hbox.Add(self.stopscale)
    self.stop2 = wx.TextCtrl(self, -1, '',  (150, 75), (120, -1))
    hbox.Add(self.stop2)
...
class PageThree(wx.Panel):
	...
	hbox = wx.BoxSizer(wx.HORIZONTAL)
	self.datapoints = wx.TextCtrl(self, -1, '',  (150, 75), (60, -1))

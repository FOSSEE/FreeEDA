#!/usr/bin/python
# openSubckt.py is a python script to open an existing subcircuit. It developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  

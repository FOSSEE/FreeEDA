#!/usr/bin/python
# newSubckt.py is a python script to create a new subcircuit for a component. It developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  
...
class SubcktInfo(template.MyTemplate):

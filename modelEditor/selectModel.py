#!/usr/bin/python
# selectModel.py is a python script to select a component to create a model. It developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  

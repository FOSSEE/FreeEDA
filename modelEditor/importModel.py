#!/usr/bin/python
# importModel.py is a python script to import a component model from library. It developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  
...
class ImportModel():
  ...
  # Collect model information available in the model library
    ...
    fileList=os.listdir(self.FreeEDA_HOME+"/modelLibrary")
    modelList=[]

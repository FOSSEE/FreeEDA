#!/usr/bin/python
# importSubckt.py is a python script to import a component subcircuit definition from library. It developed for OSCAD software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  
...
class ImportSubckt():
  ...
  # Collect model information available in the model library
    ...
    fileList=os.listdir(self.OSCAD_HOME+"/subcktLibrary")
    subcktList=[]

#!/usr/bin/python
# newSubckt.py is a python script to create a new subcircuit for a component. It developed for OSCAD software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  

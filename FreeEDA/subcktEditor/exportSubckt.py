#!/usr/bin/python
# exportSubckt.py is a python script to export a component difinition to the library. It developed for FreeEDA software. It is written by Yogesh Dilip Save (yogessave@gmail.com).  

#!/usr/bin/python
# KicadtoNgspice.py is a python script to convert a Kicad spice netlist to a ngspice netlist. It developed for FreeEDA software. It is written by FOSSEE team, IIT B.  
